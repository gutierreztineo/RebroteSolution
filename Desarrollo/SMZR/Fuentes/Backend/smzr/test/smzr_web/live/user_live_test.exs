defmodule SmzrWeb.UserLiveTest do
  ...
  @create_attrs %{is_active: true, password_hash: "some password_hash", username: "some username"}
  ...
  describe "Index" do
    ...
    test "lists all users", %{conn: conn, user: user} do
      ...
      assert html =~ user.password_hash
    end
    ...
    test "saves new user", %{conn: conn} do
      ...
      assert html =~ "some password_hash"
    end
    ...
    test "updates user in listing", %{conn: conn, user: user} do
      ...
      assert html =~ "some updated password_hash"
    end
